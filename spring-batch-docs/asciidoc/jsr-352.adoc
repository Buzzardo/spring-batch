...
Support for JSR-352 has been fully implemented. This section is not a replacement for
        ...
        Additional information on JSR-352 can be found in the
        JCP at link:$$https://jcp.org/en/jsr/detail?id=352$$[https://jcp.org/en/jsr/detail?id=352]
...
The assembly of Spring contexts (imports and so on) works with JSR-352 jobs as it would with any other
            ...
            context definition is the job definition found in /META-INF/batch-jobs/.
